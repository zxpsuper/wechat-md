...
export const theme = {
  ...
  "styles": {
    ...
    "h4": "font-size: 18px; font-weight: 600; color: #34495e !important; line-height: 1.4 !important; margin: 24px 0 16px;",
    "h5": "font-size: 17px; font-weight: 600; color: #34495e !important; line-height: 1.4 !important; margin: 20px 0 14px;",
    "h6": "font-size: 16px; font-weight: 600; color: #34495e !important; line-height: 1.4 !important; margin: 18px 0 12px;",
    "p": "margin: 20px 0 !important;font-size:15px; line-height: 1.8 !important; color: #1b1b1b !important;",
    "strong": "font-weight: 700; color: #1b1b1b !important; background-color: #fff3cd !important; padding: 2px 4px; border-radius: 8px;",
    "em": "font-style: italic; color: #666 !important;",
    "a": "color: #4a7c59 !important; text-decoration: none; border-bottom: 1px solid #4a7c59;",
    "ul": "margin: 18px 0; padding-left: 28px;",
    "ol": "margin: 18px 0; padding-left: 28px;",
    "li": "margin: 10px 0; line-height: 1.8 !important; color: #2a2a2a !important;",
    "blockquote": "margin: 16px 0; padding: 8px 16px; background-color: #f5f9fc !important; border-left: 3px solid #8fcfbe; color: #4c4c4c !important; line-height: 1.5 !important;",
    "code": "font-family: \"Fira Code\", Consolas, Monaco, \"Courier New\", monospace; font-size: 14px; padding: 3px 6px; background-color: #f5f9fc !important; color: #1B365D !important; border-radius: 8px; font-weight: 500;",
    "pre": "margin: 24px 0; padding: 20px; background-color: #f5f9fc !important;color: #1B365D !important;  border-radius: 8px; overflow-x: auto; line-height: 1.6 !important; box-shadow: 0 2px 8px rgba(0,0,0,0.1);",
